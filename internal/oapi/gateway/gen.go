...
// JSONRequest0 defines model for JSONRequest.0.
type JSONRequest0 = map[string]interface{}

// JSONRequest1 defines model for JSONRequest.1.
...
// JSONResponse0 defines model for JSONResponse.0.
type JSONResponse0 = map[string]interface{}

// JSONResponse1 defines model for JSONResponse.1.
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/gw/health", wrapper.HealthCheck)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyDelete)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyGet)
	m.HandleFunc(http.MethodHead+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyHead)
	m.HandleFunc(http.MethodOptions+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyOptions)
	m.HandleFunc(http.MethodPatch+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyPatch)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyPost)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyPut)
	m.HandleFunc(http.MethodTrace+" "+options.BaseURL+"/gw/backend/{backend}/*", wrapper.ProxyTrace)
...
func (t ProxyResponseJSONResponse) MarshalJSON() ([]byte, error) {
	return JSONResponse(t).MarshalJSON()
}

func (t *ProxyResponseJSONResponse) UnmarshalJSON(b []byte) error {
	return (*JSONResponse)(t).UnmarshalJSON(b)
}
