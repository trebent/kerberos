...
func (siw *ServerInterfaceWrapper) ListDebugSessions(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "backend", r.PathValue("backend"), &backend, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteDebugSession(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "sessionId", r.PathValue("sessionId"), &sessionId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetDebugSessionCall(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "callId", r.PathValue("callId"), &callId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteGroup(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "groupID", r.PathValue("groupID"), &groupID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "userID", r.PathValue("userID"), &userID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/superuser/login", wrapper.LoginSuperuser)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/superuser/logout", wrapper.LogoutSuperuser)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/superuser/refresh", wrapper.RefreshSuperuserSession)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/admin/superuser/password", wrapper.ChangeSuperuserPassword)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/me", wrapper.GetMe)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/users", wrapper.GetUsers)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/users", wrapper.CreateUser)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/api/admin/users/{userID}", wrapper.DeleteUser)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/users/{userID}", wrapper.GetUser)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/admin/users/{userID}", wrapper.UpdateUser)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/admin/users/{userID}/password", wrapper.ChangeUserPassword)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/admin/users/{userID}/groups", wrapper.UpdateUserGroups)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/login", wrapper.Login)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/logout", wrapper.Logout)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/refresh", wrapper.RefreshUserSession)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/groups", wrapper.GetGroups)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/groups", wrapper.CreateGroup)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/api/admin/groups/{groupID}", wrapper.DeleteGroup)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/groups/{groupID}", wrapper.GetGroup)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/admin/groups/{groupID}", wrapper.UpdateGroup)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/permissions", wrapper.GetPermissions)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions", wrapper.ListDebugSessions)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions", wrapper.StartDebugSession)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions/{sessionId}", wrapper.DeleteDebugSession)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions/{sessionId}", wrapper.GetDebugSession)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions/{sessionId}", wrapper.StopDebugSession)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions/{sessionId}", wrapper.ExtendDebugSession)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions/{sessionId}/calls", wrapper.ListDebugSessionCalls)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/debug/{backend}/sessions/{sessionId}/calls/{callId}", wrapper.GetDebugSessionCall)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/flow", wrapper.GetFlow)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/admin/oas/{backend}", wrapper.GetBackendOAS)
...
type LogoutSuperuser204ResponseHeaders struct {
	SetCookie *string
}

type LogoutSuperuser204Response struct {
	Headers LogoutSuperuser204ResponseHeaders
}
