...
type ServerInterface interface {
	...
	// (GET /api/auth/basic/organisations/{orgID}/users/me)
	GetMe(w http.ResponseWriter, r *http.Request, orgID Orgid)
...
func (siw *ServerInterfaceWrapper) DeleteOrganisation(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "orgID", r.PathValue("orgID"), &orgID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteGroup(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "groupID", r.PathValue("groupID"), &groupID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64", ValueIsUnescaped: true})
	if err != nil {
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations", wrapper.ListOrganisations)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/auth/basic/organisations", wrapper.CreateOrganisation)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}", wrapper.DeleteOrganisation)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}", wrapper.GetOrganisation)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}", wrapper.UpdateOrganisation)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/login", wrapper.Login)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/logout", wrapper.Logout)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/refresh", wrapper.Refresh)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users", wrapper.ListUsers)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users", wrapper.CreateUser)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/me", wrapper.GetMe)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/{userID}", wrapper.DeleteUser)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/{userID}", wrapper.GetUser)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/{userID}", wrapper.UpdateUser)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/{userID}/groups", wrapper.GetUserGroups)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/{userID}/groups", wrapper.UpdateUserGroups)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/users/{userID}/password", wrapper.ChangePassword)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/groups", wrapper.ListGroups)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/groups", wrapper.CreateGroup)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/groups/{groupID}", wrapper.DeleteGroup)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/groups/{groupID}", wrapper.GetGroup)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/api/auth/basic/organisations/{orgID}/groups/{groupID}", wrapper.UpdateGroup)
...
// GetMe operation middleware
func (sh *strictHandler) GetMe(w http.ResponseWriter, r *http.Request, orgID Orgid) {
